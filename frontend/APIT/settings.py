"""
Django settings for APIT project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'main.context_processors.recent_projects',
                'main.context_processors.test_suites_show',
            ],
        },
    },
]

WSGI_APPLICATION = 'APIT.wsgi.application'
